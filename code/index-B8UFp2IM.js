...
`,Y,E=class extends A{constructor(){super(),ve(this,Y,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([r,t])=>{this.constructor.define(r,t)})}emit(r,t){const e=new CustomEvent(r,F({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(e),e}static define(r,t=this,e={}){const o=customElements.get(r);if(!o){try{customElements.define(r,t,e)}catch{customElements.define(r,class extends t{},e)}return}let s=" (unknown version)",i=s;"version"in t&&t.version&&(s=" v"+t.version),"version"in o&&o.version&&(i=" v"+o.version),!(s&&i&&s===i)&&console.warn(`Attempted to register <${r}>${s}, but <${r}>${i} has already been registered.`)}attributeChangedCallback(r,t,e){me(this,Y)||(this.constructor.elementProperties.forEach((o,s)=>{o.reflect&&this[s]!=null&&this.initialReflectedProperties.set(s,this[s])}),ye(this,Y,!0)),super.attributeChangedCallback(r,t,e)}willUpdate(r){super.willUpdate(r),this.initialReflectedProperties.forEach((t,e)=>{r.has(e)&&this[e]==null&&(this[e]=t)})}};Y=new WeakMap;E.version="2.18.0";E.dependencies={};h([u()],E.prototype,"dir",2);h([u()],E.prototype,"lang",2);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,dr={name:"default",resolver:r=>he(`assets/icons/${r}.svg`)},hr=dr,Dt={caret:`
  ...
  `},ur={name:"system",resolver:r=>r in Dt?`data:image/svg+xml,${encodeURIComponent(Dt[r])}`:""},pr=ur,fr=[hr,pr],ut=[];function br(r){ut.push(r)}function gr(r){ut=ut.filter(t=>t!==r)}function Ht(r){return fr.find(t=>t.name===r)}var mr=_`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;function Et(r,t){const e=F({waitUntilFirstUpdate:!1},t);return(o,s)=>{const{update:i}=o,n=Array.isArray(r)?r:[r];o.update=function(l){n.forEach(a=>{const d=a;if(l.has(d)){const f=l.get(d),c=this[d];f!==c&&(!e.waitUntilFirstUpdate||this.hasUpdated)&&this[s](f,c)}}),i.call(this,l)}}}/**
 * @license
...
//# sourceMappingURL=index-B8UFp2IM.js.map
